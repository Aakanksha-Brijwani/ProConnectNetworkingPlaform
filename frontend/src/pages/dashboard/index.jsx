...
import {
  ...
  incrementPostLike,toggleLike, getAllComments, postComment,
} from "@/config/redux/action/postAction";
import UserLayout from "@/layout/UserLayout";
import { useRouter } from "next/router";
          ...
          <div className={styles.composeCard}>
            ...
            <div className={styles.composeInputRow}>
              ...
              <div className={styles.composeActions}>
                <label htmlFor="fileUpload" className={styles.mediaBtn}>
                ...
                />
                {postContent.length > 0 && (
                  <button className={styles.postBtn} onClick={handleUpload}>
                    Post
                  </button>
                )}
              </div>
                ...
                {postState.comments.length === 0 ? (
                  ...
                  postState.comments.map((comment) => (
                    <div key={comment._id} className={styles.commentRow}>
                      <p className={styles.commentName}>{comment.userId.name}
